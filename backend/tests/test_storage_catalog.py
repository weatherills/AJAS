...
def test_partition_keys_match_query_patterns():
    ...
    assert container_by_id("resume_contacts").partition_key == "/resume_id"
    assert container_by_id("resume_skills").partition_key == "/resume_id"
    assert container_by_id("resume_experiences").partition_key == "/resume_id"
    assert container_by_id("resume_educations").partition_key == "/resume_id"
