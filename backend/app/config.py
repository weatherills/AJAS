...
class Settings(BaseSettings):
    ...
    flag_glassdoor_adapter: bool = True
    flag_wellfound_adapter: bool = True
    flag_workday_adapter: bool = True
    flag_ziprecruiter_adapter: bool = True
    flag_hired_adapter: bool = True
    flag_greenhouse_career_adapter: bool = True
