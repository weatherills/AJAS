...
def feature_flags() -> dict[str, bool]:
    ...
    return {
        ...
        "ziprecruiter_adapter": bool(settings.flag_ziprecruiter_adapter),
        "hired_adapter": bool(settings.flag_hired_adapter),
        "greenhouse_career_adapter": bool(settings.flag_greenhouse_career_adapter),
        "lever_career_adapter": bool(settings.flag_lever_career_adapter),
